...
export default function Footer() {
  return (
    <footer className="mt-24 bg-custom-radial">
      <div className="p-4 py-6 mx-auto max-w-screen-xl md:p-8 lg:-10">
        <div className="grid grid-cols-2 gap-8 lg:grid-cols-5">
          <div className="col-span-2">
            ...
            <p className="my-4 text-sm text-footer-elements">
              ...
              efficiency and community shape personalized AI solutions.
            </p>
        ...
        <hr className="my-6 border-[#564778] sm:mx-auto lg:my-8" />
        <span className="block text-sm text-center text-footer-elements">
          © 2024{" "}
          <a href="#" className="hover:underline">
            AlphaNeural AI
          </a>
